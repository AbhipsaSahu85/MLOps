...
model_path = hf_hub_download(repo_id="AbhipsaSahu/churn-model", filename="best_churn_model.joblib")
...
if st.button("Predict"):
    ...
    st.write(f"Based on the information you provided, the customer is likely to {result}.")
